...
public class AlunoService {
    ...
    public List<AlunoRepository> getAllAluno() {
        return alunoRepository.findAll();
    }

    public Aluno getAlunoById(Long id) {
        Optional<AlunoRepository> aluno = alunoRepository.findById(id);
        return alunoRepository.orElse(null);
    }
    //Query Method 
    public List<AlunoRepository> buscarAlunosPorCidade(String cidade) {
        return alunoRepository.findByCidade(cidade); 
      }
    //Query Method 
    public List<AlunoRepository> buscarAlunosPorNomeERenda(String nome, Double renda) {
